...
class PauseScreen(QWidget):
    ...
    def paintEvent(self, event):
        ...
        # Optimization: Use cached pre-scaled image to avoid expensive resizing on every paint event
        if not self._scaled_background and not self.background.isNull():
            self._update_scaled_background()
