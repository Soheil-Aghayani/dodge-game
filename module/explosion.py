...
class ExplosionAnimation(Animation):
    def __init__(self, x, y, size):
        ...
        # Pre-scale explosion frames for performance optimization
        self.scaled_frames = []
        if self.frames:
            ...
            for frame in self.frames:
                if frame:
                    ...
                    self.scaled_frames.append(frame.scaled(self.scaled_size, self.scaled_size, Qt.KeepAspectRatio, Qt.FastTransformation))
                else:
